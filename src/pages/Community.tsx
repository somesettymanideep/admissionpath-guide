...
const initialQuestions: Question[] = [
  ...
  {
    id: 2,
    title: "How to prepare for JEE Main in the last 3 months?",
    body: "I'm currently scoring around 150 in mock tests. I want to improve my score significantly. Any tips for the last 3 months of preparation?",
    author: "Sneha Reddy",
    initials: "SR",
    category: "Exam Prep",
    upvotes: 31,
    ...
    isUpvoted: false,
    answers: [
      { id: 3, author: "Vikram Singh", initials: "VS", text: "Focus on Physics numericals and Math — they carry the most marks. Solve previous year papers regularly and maintain an error log for revision.", upvotes: 15, time: "3 hours ago", isUpvoted: false },
    ],
  },
  {
    id: 3,
    ...
    isUpvoted: false,
    answers: [
      { id: 4, author: "Rohan Gupta", initials: "RG", text: "Both are good options. VIT generally has slightly higher average placement packages, but SRM also has strong industry connections. Visit both campuses if possible.", upvotes: 28, time: "20 hours ago", isUpvoted: false },
      { id: 5, author: "Kavita Nair", initials: "KN", text: "I'm at VIT and the placement cell is quite active. That said, your skills and internships matter more than the college name in the long run.", upvotes: 22, time: "18 hours ago", isUpvoted: false },
    ],
  },
  {
    id: 4,
